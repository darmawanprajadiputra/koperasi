...
const cfg =
    typeof window.StorageConfig !== "undefined" ? window.StorageConfig : null;
...
function initBladeProducts() {
        ...
        searchInput.addEventListener("input", () => {
            ...
            filteredData = allProducts.filter(
                (p) =>
                    ...
                    (p.category &&
                        p.category.name_categories.toLowerCase().includes(q)) ||
    ...
    document.addEventListener("click", (e) => {
        ...
        if (btn) {
            ...
            if (toggleIcon)
                toggleIcon.textContent = activeProduct.is_active
                    ? "toggle_off"
                    : "toggle_on";
            if (toggleLabel)
                toggleLabel.textContent = activeProduct.is_active
                    ? "Nonaktifkan"
                    : "Aktifkan";
