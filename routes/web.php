...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/storage', [ProductController::class, 'index'])->name('storage');
    ...
    Route::prefix('api')->group(function () {
        ...
        Route::put('/order/{order_id}/status', [OrderController::class, 'updateStatus'])->name('api.order.update-status');
